...
var pluginKey = "infobeat.monitor"

var statsRegistry = monitoring.Default.NewRegistry("infobeat")
var stateRegistry = monitoring.GetNamespace("state").GetRegistry().NewRegistry("infobeat")
...
// monitorStarts
type PluginBuilder func(string, *common.Config) (jobs []jobs.Job, err error)
...
func (e *pluginBuilder) create(cfg *common.Config) (jobs []jobs.Job, err error) {
